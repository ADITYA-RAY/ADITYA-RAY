    ...
    <div>
      ...
      <div className="project_wrapper" id="projects">
        ...
        <Row>
          ...
          <Col xs={12} md={6}>
            <Fade bottom>
              <a
                href="https://adityaray.netlify.app"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <div className="pro_card">
                ...
                <div className="web_links">
                  <a
                    href="https://github.com/ADITYA-RAY"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <SiGithub />
      ...
      <div className="project_wrapper">
        <Row>
          ...
          <Col xs={12} md={6}>
            <Fade bottom>
              <a href="https://lemmebuy.in/" target="_blank" rel="noreferrer">
      ...
      <div className="project_wrapper">
        <Fade bottom>
          <Row>
            ...
            <Col xs={12} md={4}>
              <a
                href="https://robotix.nitrr.ac.in"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <Col xs={12} md={4}>
              <a
                href="https://fudview.netlify.app"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <Fade bottom>
          <Row>
            ...
            <Col xs={12} md={4}>
              <a
                href="https://calceasy.netlify.app"
                target="_blank"
                rel="noreferrer"
              >
